...
public class withname {
    ...
    public static void main(String[] args) {
        ...
        JLabel titleLabel = new JLabel("Disk Scheduling Algorithms");
        titleLabel.setFont(new Font("Arial", Font.BOLD, 20));

        JLabel nameLabel = new JLabel(" - Arnoza Bringuelo Buco");
        ...
        buttonPanel.setLayout(new GridLayout(1, 3, 10, 10)); // 1 row, 3 columns, spacing
        ...
        sstfButton.setPreferredSize(buttonSize);
        roundRobinButton.setPreferredSize(buttonSize);
        priorityButton.setPreferredSize(buttonSize);
